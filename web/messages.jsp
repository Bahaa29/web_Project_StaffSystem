...
<div class="container">
    <h1 class="page_title">Messages</h1>
    <div class="row">
        <div class="col-md-6 center_div">
            <%out.println(session.getAttribute("StaffMessagesTable"));%>
        </div>
    </div>
</div>
<div class="container">
    <form action="messageOne.jsp" method="post">
        <input type="submit" value="New Message" class="btn btn-primary">
    </form>

    <form action="selectSublect.jsp" method="post">
        <input type="submit" value="Message Team" class="btn btn-primary">
    </form>
</div>
</body>
</html>
